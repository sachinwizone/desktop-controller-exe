...
const app = {
    ...
    // Helper function to format timestamp from database in 24-hour format (DD/MM/YYYY HH:MM:SS)
    // No timezone conversion - displays raw UTC time from database
    // Time format: 00:00-23:59 (24-hour format, no AM/PM)
        ...
        appContainer.innerHTML = `
            ...
            <div class="sidebar" style="width: 280px; height: 100vh; background: linear-gradient(180deg, #0f2847 0%, #0a1e2e 100%); color: white; display: flex; flex-direction: column; overflow-y: auto; border-right: 1px solid rgba(23, 162, 184, 0.2); box-shadow: 4px 0 20px rgba(13, 127, 191, 0.15);">
                ...
                <div style="flex: 1; padding: 20px 0;">
                    ...
                    <div class="menu-section" style="margin-top: 24px;">
                        <div style="padding: 0 20px; margin-bottom: 12px; font-size: 11px; font-weight: 600; color: #64748b; text-transform: uppercase; letter-spacing: 0.5px;">SYSTEM CONTROL</div>
                        <nav>
                            <a class="menu-item" onclick="app.navigate('chat')" data-view="chat" style="display: flex; align-items: center; gap: 12px; padding: 12px 20px; color: #94a3b8; text-decoration: none; transition: all 0.2s; cursor: pointer;" onmouseover="this.style.background='#334155'; this.style.color='#e2e8f0'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
                                </svg>
                                <span style="font-size: 14px; font-weight: 500;">💬 Chat System</span>
                            </a>
                            ...
                            <a class="menu-item" onclick="app.navigate('system-control')" data-view="system-control" style="display: flex; align-items: center; gap: 12px; padding: 12px 20px; color: #94a3b8; text-decoration: none; transition: all 0.2s; cursor: pointer;" onmouseover="this.style.background='#334155'; this.style.color='#e2e8f0'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">
                                ...
                                <span style="font-size: 14px; font-weight: 500;">🖥️ System Control</span>
                            </a>
                            
                            <a class="menu-item" onclick="app.navigate('app-manager')" data-view="app-manager" style="display: flex; align-items: center; gap: 12px; padding: 12px 20px; color: #94a3b8; text-decoration: none; transition: all 0.2s; cursor: pointer;" onmouseover="this.style.background='#334155'; this.style.color='#e2e8f0'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <rect x="2" y="3" width="20" height="14" rx="2" ry="2"/>
                                    <line x1="8" y1="21" x2="16" y2="21"/>
                                    <line x1="12" y1="17" x2="12" y2="21"/>
                                </svg>
                                <span style="font-size: 14px; font-weight: 500;">📦 Application Manager</span>
                            </a>
                            
                            <a class="menu-item" onclick="app.navigate('user-management')" data-view="user-management" style="display: flex; align-items: center; gap: 12px; padding: 12px 20px; color: #94a3b8; text-decoration: none; transition: all 0.2s; cursor: pointer;" onmouseover="this.style.background='#334155'; this.style.color='#e2e8f0'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/>
                                    <circle cx="9" cy="7" r="4"/>
                                    <path d="M23 21v-2a4 4 0 0 0-3-3.87"/>
                                ...
                                <span style="font-size: 14px; font-weight: 500;">👥 User Management</span>
                            </a>
                            
                            <a class="menu-item" onclick="app.navigate('system-settings')" data-view="system-settings" style="display: flex; align-items: center; gap: 12px; padding: 12px 20px; color: #94a3b8; text-decoration: none; transition: all 0.2s; cursor: pointer;" onmouseover="this.style.background='#334155'; this.style.color='#e2e8f0'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <circle cx="12" cy="12" r="3"/>
                                    <path d="M12 1v6m0 6v6m6-12h-6m-6 0h6"/>
                                </svg>
                                <span style="font-size: 14px; font-weight: 500;">⚙️ Settings Control</span>
                            </a>
                            
                            <a class="menu-item" onclick="app.navigate('remote-commands')" data-view="remote-commands" style="display: flex; align-items: center; gap: 12px; padding: 12px 20px; color: #94a3b8; text-decoration: none; transition: all 0.2s; cursor: pointer;" onmouseover="this.style.background='#334155'; this.style.color='#e2e8f0'" onmouseout="this.style.background='transparent'; this.style.color='#94a3b8'">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <line x1="2" y1="3" x2="22" y2="3"/>
                                    <path d="M5 6h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z"/>
                                </svg>
                                <span style="font-size: 14px; font-weight: 500;">🎛️ Remote Commands</span>
                            </a>
                        </nav>
                    </div>
